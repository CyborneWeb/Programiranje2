...
static void kalkulator(int a, int b) {
    if (b == 0) {
        IO.println("Napaka: deljenje z 0");
        return;
    }
...
static void nicli(int a, int b, int c) {
    ...
    if (d < 0) {
        IO.println("Napaka: nicli enacbe ne obstajata");
        return;
    }
...
static void veckratnikDeljitelj(int a, int b) {
    if (Math.min(a, b) == 0) {
        IO.println("Napaka: obe števili morata biti različni od nič.");
        return;
    }
