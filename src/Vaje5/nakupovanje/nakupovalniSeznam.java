        ...
        do {
            ...
            switch (ukaz) {
                ...
                case '1': // ustvari seznam
                    ...
                    dol = sc.nextInt();
                    if (Vaje5.nakupovanje.zbirke.Seznam.narediSeznam(dol))
                ...
                case '2': // dodaj element na konec
                    ...
                    element = sc.next();
                    if (Vaje5.nakupovanje.zbirke.Seznam.dodajNaKonecSeznama(element))
                ...
                case '3': // vrini element na mesto
                    ...
                    mesto = sc.nextInt();
                    if (Vaje5.nakupovanje.zbirke.Seznam.dodajVSeznam(element, mesto))
                ...
                case '4': // odstrani element na mestu
                    ...
                    mesto = sc.nextInt();
                    element = Vaje5.nakupovanje.zbirke.Seznam.odstraniIzSeznama(mesto);
                    if (element != null)
                ...
                case '5': // vrni dolžino seznama
                    dol = Vaje5.nakupovanje.zbirke.Seznam.dolzinaSeznama();
                    if (dol >= 0)
                ...
                case '6': // izpiši seznam
                    Vaje5.nakupovanje.zbirke.Seznam.izpisiSeznam();
                    break;
                case '7': // izpiši 64-bitno
                    //Vaje5.nakupovanje.zbirke.Seznam.izpisiSeznam64Bit();
                    break;
                case '8': // uniči seznam
                    if (Vaje5.nakupovanje.zbirke.Seznam.uniciSeznam())
