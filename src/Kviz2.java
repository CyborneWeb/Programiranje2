    ...
    return vsota;
        ...
        static boolean preveriRep(String a, String b) {
            ...
            if (a.length() > b.length()) {
                rep = a.substring(a.length() - b.length()).toLowerCase();
                return b.toLowerCase().equals(rep);

            } else {
                rep = b.substring(b.length() - a.length()).toLowerCase();
                return a.toLowerCase().equals(rep);
            }
        }
